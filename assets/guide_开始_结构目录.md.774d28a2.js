import{_ as p,o as e,c as i,L as r,w as d,b as _,e as y,k as l,a as b,V as u,H as t}from"./chunks/framework.08d5879c.js";const A=JSON.parse('{"title":"结构目录","description":"","frontmatter":{"title":"结构目录"},"headers":[],"relativePath":"guide/开始/结构目录.md","filePath":"guide/开始/结构目录.md","lastUpdated":1690339581000}'),m={name:"guide/开始/结构目录.md"},f=l("h1",{id:"yunzai-结构主要目录",tabindex:"-1"},[b("Yunzai 结构主要目录 "),l("a",{class:"header-anchor",href:"#yunzai-结构主要目录","aria-label":'Permalink to "Yunzai 结构主要目录"'},"​")],-1),h=u(`<blockquote><p>这里只显示主要结构，毕竟整个目录包括子文件夹太多了，不知道也没关系统, <s>绝对不是我写不出来</s></p></blockquote><hr><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark-dimmed"><code><span class="line"><span style="color:#adbac7;">.Yunzai</span></span>
